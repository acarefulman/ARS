...
Enhancements:
- Residual GCN Fusion
- Attention-based GCN with Regularization
- Learnable Modality Fusion with Constraints
- Training Logging for Diagnostic
"""
...
class DSFCGP(GeneralRecommender):
    def __init__(self, config, dataset):
        super(DSFCGP, self).__init__(config, dataset)
        self.sparse = True
